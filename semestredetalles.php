...
<html>
    <head>
        ...
        <title>Mi Panel-Semestres</title>
            ...
            <div class="row">
                <div class="card col-md-10 mx-auto">
                    <div class="card-header row">
                        ...
                        <div class="col-6 pt-3 text-end">Mis Semestres</div>                   
                    </div>
                    <div class="card-body row">
                        <?php include "semestre.php"; ?>
                    </div>
                    <div class="p-2 text-end">
                        <a href="principal.php" class="btn m-2" id="btn">Regresar</a>
                    </div>
                </div>
            </div>
        </div>
